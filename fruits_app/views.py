...
def fruits_list(request):
    fruits = [
  { "name": "Apfel", "weight": 180, "color": "grün" },
  ...
  { "name": "Feige", "weight": 50, "color": "lila" },
